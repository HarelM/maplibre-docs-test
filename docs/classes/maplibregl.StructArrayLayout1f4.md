[maplibre-gl-js@3.1.x](../README.md) / [Exports](../modules.md) / [maplibregl](../modules/maplibregl.md) / StructArrayLayout1f4

# Class: StructArrayLayout1f4

[maplibregl](../modules/maplibregl.md).StructArrayLayout1f4
...
- [`StructArray`](maplibregl.StructArray.md)
  ...
  ↳↳ [`GlyphOffsetArray`](maplibregl.GlyphOffsetArray.md)

## Table of contents

### Methods

- [\_trim](maplibregl.StructArrayLayout1f4.md#_trim)
- [clear](maplibregl.StructArrayLayout1f4.md#clear)
- [reserve](maplibregl.StructArrayLayout1f4.md#reserve)
- [resize](maplibregl.StructArrayLayout1f4.md#resize)
- [serialize](maplibregl.StructArrayLayout1f4.md#serialize)
